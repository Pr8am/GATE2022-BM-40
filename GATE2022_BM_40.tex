...
\\
For a unit impulse input $\brak{x(t) = \delta(t)}${ to both systems, gain $\beta$ is chosen such that $y \brak{4T}$ is same for both systems. The value of $\beta$ is:
\begin{figure}[ht]
    \centering
...
\begin{align}
y_I &= e^{- \alpha t} u\brak{t}
\end{align}
\begin{align}
y_R &= \sbrak{\beta \brak{ u\brak{t} - u\brak{t-5T}} + e^{- \alpha \brak{t - T}} u\brak{t-T}}
\end{align}
